...
class Changecountrycontroller extends GetxController {
  ...
  RxBool isloading = false.obs;
  var value = LocalizationService.currentCountry.obs;
  ...
  handleSubmit(var data) {
    ...
    try {
      ...
      repository.ChangeCountryApiCall(dataBody: data).then((value) async {
        if (value != null) {
