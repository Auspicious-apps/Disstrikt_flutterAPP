...
import 'package:disstrikt/app/modules/jobs/controllers/Portfolio_For_View_Controller.dart';
...
class Portfolioforview extends StatelessWidget {
  const Portfolioforview({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return GetBuilder<PortfolioForViewController>(
      init: PortfolioForViewController(),
      builder: (controller) {
                                                                    ...
                                                                    onTap:
                                                                      ...
                                                                      if (await canLaunchUrl(
                                                                        ...
                                                                        ScaffoldMessenger.of(context)
                                                                            .showSnackBar(
                                                                          SnackBar(
                                                                              content: Text('Could not open URL: $uri')),
                                                                        );
                                                                      }
                                                                    },
                                                                    child:
                                                                  ...
                                                                  child: Row(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      TextView(
                                                                          ...
                                                                          textStyle:
                                                                              TextStyle(
                                                                            color: controller.isImages.value == true
                                                                  ...
                                                                  child: Row(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      TextView(
                                                                          ...
                                                                          textStyle:
                                                                              TextStyle(
                                                                            color: controller.isImages.value == false
                                                                                ? AppColors.clickTextColor
                                                                                : AppColors.blackColor,
                                                                            fontSize:
                                                                                12,
                                                            ...
                                                            : controller
                                                                ...
                                                                ? Column(
                                                                    children: [
                                                                      ...
                                                                      TextView(
                                                                        text: "strEmptyportfolioSubheading"
                                                                            .tr,
                                                                        maxLines:
                                                                            4,
                                                                        textAlign:
                                                                  ...
                                                                  return GestureDetector(
                                                                    onTap:
                                                                      ...
                                                                      showDialog(
                                                                        ...
                                                                        builder:
                                                                            (_) =>
                                                                                VideoDialog(videoUrl: "${imageBaseUrl}${controller.portfolioResponseModel.value.data?.videos?[index].url}"),
                                                                      );
                                                                    },
                                                                    child:
                                                                        Column(
                                                                      ...
                                                                      children: [
                                                                        Row(
                                                                          ...
                                                                          children: [
                                                                            TextView(
                                                                              text: image?.title == "catwalkVideo"
                                                                                  ? "catwalkVideo".tr
                                                                                  : image?.title == "introVideo"
                                                                                      ? "introVideo".tr
                                                                                      : "strOthers".tr,
                                                                              textStyle: const TextStyle(
                                                                                color: AppColors.blackColor,
