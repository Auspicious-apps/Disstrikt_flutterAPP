...
import '../../bottom_tab/controllers/bottom_tab_controller.dart';
...
class StartJourney extends StatelessWidget {
                                        ...
                                        children: [
                                                          ...
                                                          child: Container(
                                                              ...
                                                              decoration:
                                                                ...
                                                                color: controller.userResponseModel?.value.data?.milestoneData?[index]?.attempted ==
                                                                            true &&
                                                                        controller.userResponseModel?.value.data?.milestoneData?[index]?.rating !=
                                                                            0
                                                                    ? AppColors
                                                                        .clickTextColor
                                                                    : AppColors
                                          ...
                                          GestureDetector(
                                            ...
                                            onTap: () async {
                                              Get.closeAllSnackbars();
                                              print(
                                                  'Tapped Index: $index, Task Number: ${controller.userResponseModel?.value.data?.milestoneData?[index]?.taskNumber}');
                                              Get.closeAllSnackbars();
                                              if (controller
                                                          .userResponseModel
                                                          ?.value
  ...
  Widget CustomArcStarRating({
    ...
    return SizedBox(
      height: starSize + arcRadius,
      width: starSize * starCount * 1.5,
      child: Stack(
        ...
        children: List.generate(starCount, (index) {
          ...
          return Positioned(
            left: starSize * 1.5 * index + starSize * 0.25,
            top: verticalOffset,
            child: Icon(
              Icons.star,
              size: starSize,
              ...
              Row(
                children: [
                  controller.isLoading.value == false
                      ? GestureDetector(
                          onTap: () {
                            Get.put(BottomTabController()).changeIndex(4);
                          },
                          child: Container(
                  ...
                  GestureDetector(
                    ...
                    child: Stack(
                      children: [
                        ...
                        Obx(() => controller.userResponseModel?.value?.data
                                    ?.unreadNotifications !=
                                0
                            ? Positioned(
                                top: 0,
                                ...
                                child: Container(
                                  ...
                                  child: Center(
                                    child: TextView(
                                      text:
                                          "${controller.userResponseModel?.value?.data?.unreadNotifications ?? ""}",
                                      textStyle: TextStyle(
                                        fontSize: 12,
